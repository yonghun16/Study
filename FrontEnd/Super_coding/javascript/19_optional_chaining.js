 ...
 * Optional Chaining(?.) : 객체의 중첩된 속성을 안전하게 접근할 수 있도록 도와주는 연산자
   1. undefined와 null에서는 속성(property)를 참조할 수 없음
   2. 객체의 '속성이 존재하지 않아도' 오류 없이 undefined 반환
...
// 1. 
// 'undefined의 속성' 접근 시 예외처리
console.log("\n--- 1.");
if(weekdays.wed) {
  console.log("ES5 ", weekdays.wed.open);
}
